...
const infoData = [
  ...
  { label: "Email", value: "yashatkari7@gmail.com" },
  { label: "Study", value: "G H Raisoni College of Engineering, Nagpur" },
            ...
            <div className="container">
                ...
                <div className="col-12 col-md-6 col-lg-8">
                    ...
                    <div className="info-grid row">
                        {infoData.map(({ label, value }, i) => (
                        <div className="info-item col-md-6 mb-4" key={i}>
                            <span className="label fs-5 fw-bold" style={{ color: "violet" }}>{label}</span><br />
